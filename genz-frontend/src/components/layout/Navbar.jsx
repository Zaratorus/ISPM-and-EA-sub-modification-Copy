...
// Clothing / Boys' Clothing / Perfumes) so the header doesn't reflow once
    ...
    <header className={styles.header}>
      <div className={`${styles.bar} container`}>
        ...
        <Link to="/" className={styles.logo} aria-label="Gen-Z home">
          ...
          <span className={styles.logoTagline}>Men&rsquo;s &middot; Boys&rsquo; &middot; Fragrance</span>
        </Link>
